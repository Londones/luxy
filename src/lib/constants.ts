...
import LuxyCategory from "@/components/icons/plura-category";
...
export const addOnProducts = [
  { title: "Priority Support", id: "prod_PrJGt3vOfONbND" },
];

export const pricingCards = [
  {
    title: "Starter",
    description: "Perfect for building a personal site",
    price: "Free",
    duration: "",
    highlight: "Key features",
    features: [
      "1 free website",
      "Stripe Support to sell your own products",
  ...
  },
  {
    ...
    duration: "month",
    highlight: "Key features",
    features: ["Unlimited free websites", "24/7 Support team"],
    priceId: "price_1P1aQmRrI6irc5AUoWmoS2q5",
  },
  {
    title: "Basic",
    ...
    features: ["2 websites", "Extensive dashboard", "Custom domain support"],
    priceId: "price_1P1aQmRrI6irc5AUmSmRO1wy",
  },
];
