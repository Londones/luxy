...
const Page = async ({ params }: Props) => {
  ...
  const currentPlanDetails = pricingCards.find(
    (c) => c.priceId === userSubscription?.Subscription?.priceId
  );
  ...
  return (
    <>
      <SubscriptionHelper
        ...
        planExists={userSubscription?.Subscription?.active === true}
      />
      <BlurPage>
        ...
        <div className="flex flex-col lg:!flex-row justify-between gap-8">
          <PricingCard
            ...
            customerId={userSubscription?.customerId || ""}
            amt={
              userSubscription?.Subscription?.active === true
              ...
              <TableRow key={charge.id}>
                ...
                <TableCell>
                  <p
                    className={clsx("", {
                      "text-emerald-500":
                        charge.status.toLowerCase() === "succeeded",
                      "text-orange-600":
