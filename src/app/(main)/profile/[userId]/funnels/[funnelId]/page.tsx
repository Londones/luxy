...
const FunnelPage = async ({ params }: Props) => {
  ...
  if (!funnelPages) return redirect(`/profile/${params.userId}/funnels`);

  return (
    <BlurPage>
      <Link
        href={`/profile/${params.userId}/funnels`}
      ...
      <Tabs defaultValue="steps" className="w-full">
        ...
        <TabsContent value="settings">
          <FunnelSettings userId={params.userId} defaultData={funnelPages} />
        </TabsContent>
      </Tabs>
    </BlurPage>
  );
