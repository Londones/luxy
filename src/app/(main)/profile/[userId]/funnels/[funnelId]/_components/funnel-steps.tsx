...
const FunnelSteps = ({ funnel, userId, pages, funnelId }: Props) => {
  ...
  return (
    <AlertDialog>
      <div className="flex border-[1px] lg:!flex-row flex-col">
        ...
        <aside className="flex-[0.7] bg-background p-4">
          {!!pages.length ? (
              ...
              <CardHeader>
                ...
                <CardDescription className="flex flex-col gap-4">
                  <div className="border-2 rounded-lg sm:w-80 w-full  overflow-clip">
                    <Link
                      href={`/profile/${userId}/funnels/${funnelId}/editor/${clickedPage?.id}`}
